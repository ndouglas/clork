...
(defn set-game-flag
  "Set a game-level flag."
  [game-state flag]
  (assoc game-state flag true))

(defn unset-game-flag
  "Unset a game-level flag."
  [game-state flag]
  (assoc game-state flag false))
...
(defn move-object
  ...
  ([game-state obj-id to _reason]
   (assoc-in game-state [:objects obj-id :in] to)))
